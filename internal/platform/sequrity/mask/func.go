...
// PasswordMask completely masks the password value by replacing it with the * symbol.
//
// Examples:
//   - "password" - "*";
//   - "" - "*".
func PasswordMask(_ string) string {
	return "*"
}

// EmailMask masks every character of the email (except the first and last characters),
...
func EmailMask(email string) string {
	const (
...
// PhoneMask masks some digits of the number, leaving the last 2 digits exactly.
//
// Examples:
//   - "+78005553535" - "+7800*****35";
